    ...
    <div class="card profile-edit-card shadow-sm">
        <form action="<?= base_url('/profile/change-password') ?>" method="post">
            ...
            <section class="profile-edit-section">
                ...
                <div class="row g-3">
                    <div class="col-12"><label for="currentPassword" class="form-label fw-semibold">Password Lama</label><input id="currentPassword" type="password" name="current_password" class="form-control" autocomplete="current-password" required></div>
                    <div class="col-md-6"><label for="newPassword" class="form-label fw-semibold">Password Baru</label><input id="newPassword" type="password" name="new_password" class="form-control" autocomplete="new-password" minlength="8" required></div>
                    <div class="col-md-6"><label for="newPasswordConfirmation" class="form-label fw-semibold">Konfirmasi Password Baru</label><input id="newPasswordConfirmation" type="password" name="new_password_confirmation" class="form-control" autocomplete="new-password" minlength="8" required></div>
                </div>
            </section>
