...
<head>
    ...
    <title>500 - Kesalahan Server | .tmp Project Management</title>
...
<body>
    <div class="error-card">
        <img src="<?= base_url('assets/images/error/image_error500.png') ?>" alt="Error 500 - Internal Server Error" class="img-error">
        
        <h1 class="error-title">Kesalahan Server</h1>
        
        <p class="error-message">
            Terjadi kesalahan pada server, silakan coba lagi nanti atau hubungi administrator jika masalah berlanjut.
        </p>
